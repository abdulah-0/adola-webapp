-- =====================================================
-- ADD GAME CONFIGS TABLE FOR ADMIN WIN RATE MANAGEMENT
-- This table stores game configuration settings that can be modified by admins
-- =====================================================
