...
const WebFootballBettingGame: React.FC = () => {
      ...
      <View style={styles.webContainer}>
        ...
        {gamePhase === 'betting' && selectedMatch && (
          <View style={styles.section}>
            ...
            <View style={styles.webBettingGrid}>
              {odds.map((market) => (
                <View key={market.key} style={styles.webMarketContainer}>
            ...
            {/* Betting Form */}
            {selectedBet && (
              <View style={styles.webBettingForm}>
        ...
        {gamePhase === 'history' && (
          <View style={styles.section}>
            ...
            {bets.length === 0 ? (
              ...
              <View style={styles.webBetsContainer}>
                {bets.map((bet) => (
                  <View key={bet.id} style={styles.webBetCard}>
...
export default WebFootballBettingGame;
